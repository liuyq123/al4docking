...
# Modified from https://github.com/deepchem/deepchem/blob/master/deepchem/models/optimizers.py
# Added CyclicLR, LinearLR, CosineAnnealingLR, and SequentialLR
...
class CyclicLR(LearningRateSchedule):
...
class SequentialLR(LearningRateSchedule):
    ...
    def _create_pytorch_schedule(self, optimizer):
        ...
        for scheduler in self.schedulers:
            schedulers.append(scheduler._create_pytorch_schedule(optimizer))
